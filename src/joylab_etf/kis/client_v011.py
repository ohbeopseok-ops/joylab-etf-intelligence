...
class KISClient:
    ...
    def authenticate(self) -> str:
        ...
        if cached:
            ...
            print("[PASS] cached KIS token reused")
        ...
        if response.status_code == 403:
            raise RuntimeError(
                "KIS token endpoint 403. 최근 1분 이내 토큰 발급 이력이 있을 수 있습니다. "
                "기존 캐시 토큰이 없다면 잠시 후 다시 실행하세요."
            )
        ...
        print("[PASS] new KIS token issued and cached")
        return token
